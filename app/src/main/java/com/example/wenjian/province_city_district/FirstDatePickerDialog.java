 ...
 * </p>
 */
public class FirstDatePickerDialog extends AlertDialog implements
	...
	public FirstDatePickerDialog(Context context, OnDateSetListener callBack,
			int year, int monthOfYear, int dayOfMonth) {
		this(context, 0, callBack, year, monthOfYear, dayOfMonth);
	}

	public FirstDatePickerDialog(Context context, int theme,
	...
	public FirstDatePickerDialog(Context context, int theme,
		...
		//mDatePicker_start.setMaxDate(Long.parseLong(new SimpleDateFormat("MM/dd/yyyy").format(new Date())));
		//mDatePicker_start.setMaxDate(12/31/2100);//设置显示最后日期,失败
		// 如果要隐藏当前日期，则使用下面方法。
		if (!isDayVisible) {
